...
Squid.prototype.setup = function( options )
{
  ...
  // Setup logger and return engine instance
  this._LOGGER  = new Logger( this._CONFIG.get('logger', false) ).get()
...
Squid.prototype.log = function()
{
  ...
  this._LOGGER.print.apply( this, arguments )
}
...
Squid.prototype.logs = function( messages )
{
  ...
  _.forEach(  messages, function( message )
  {
    ...
    this._LOGGER.print.apply( this, message )
  }, this)
}
