...
Squid.prototype.setup = function( options )
{
  ...
  this._CONFIG  = new Config( 'core', options.configPath || __dirname + '/config/', options.config || 'prod', options.env || {}  )
  ...
  // Setup logger
  if( this._CONFIG.get('logger', false) )
  {
    // TODO: pass logger lib as option
